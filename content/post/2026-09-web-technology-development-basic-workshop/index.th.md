...
สิ่งที่ผมประทับใจคือความสนใจ ความร่วมมือ และ Productivity ของนิสิตตลอดช่วงเวลาที่เราเรียนด้วยกัน หลายคนสามารถเริ่มจากพื้นฐานและค่อย ๆ ต่อชิ้นส่วนของระบบจนเห็นภาพของ Full-stack Application ได้จริง

สำหรับผม การกลับมาที่มหาวิทยาลัยครั้งนี้จึงไม่ใช่เพียงการถ่ายทอดความรู้ แต่เป็นประสบการณ์ที่ช่วยเติมพลังให้กับตัวเองด้วยเช่นกัน มันทำให้ผมย้อนกลับมาถามอีกครั้งว่า ทำไมผมถึงชอบงาน Software Development และทำไมการแบ่งปันความรู้ด้านนี้จึงมีความหมาย
...
สื่อและ Hands-on Lab ที่ใช้ใน Workshop ครั้งนี้เปิดไว้บน GitHub:

**[suriyasonp/web-tech-ku-workshop](https://github.com/suriyasonp/web-tech-ku-workshop)**

Repository นี้รวบรวมเนื้อหาสำหรับการเรียนรู้พื้นฐาน Web Technology Development ทั้ง Backend, Frontend และ Workflow ที่ใช้ในการอบรมครั้งนี้
